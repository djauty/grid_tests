...
export LFC_HOME=/grid/snoplus.snolab.ca/myproxytests/rlwms
...
for ((h=0;h<=10;h++));do
	...
	lcg-cr -d ${targetSE} -P myproxytests/rlwms/${foutname} -l lfn:/grid/snoplus.snolab.ca/myproxytests/rlwms/${foutname} file://$(pwd)/proxyinfo
	busywait 600
    done
done
