...
export LFC_HOME=/grid/snoplus.snolab.ca/myproxytests/glwms
...
for ((h=0;h<=10;h++));do
	...
	lcg-cr -d ${targetSE} -P myproxytests/glwms/${foutname} -l lfn:/grid/snoplus.snolab.ca/myproxytests/glwms/${foutname} file://$(pwd)/proxyinfo
	busywait 600
    done
done
